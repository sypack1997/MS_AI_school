...
def parse_opt(known=False):
    ...
    parser.add_argument('--cfg', type=str, default='./models/yolov5l6.yaml', help='model.yaml path')
    ...
    parser.add_argument('--optimizer', type=str, choices=['SGD', 'Adam', 'AdamW','SGDP', 'AdamP'], default='AdamW', help='optimizer')
