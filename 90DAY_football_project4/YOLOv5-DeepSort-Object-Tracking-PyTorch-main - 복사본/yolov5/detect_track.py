...
def parse_opt():
    ...
    parser.add_argument('--weights', nargs='+', type=str, default=ROOT / 'runs/train/exp_0208/weights/v5x_best.pt', help='model path(s)')
    parser.add_argument('--source', type=str, default=ROOT / 'dataset', help='file/dir/URL/glob, 0 for webcam')
    ...
    parser.add_argument('--name', default='exp_0209_video2', help='save results to project/name')
